...
<div id="frame">
	...
	<tr>
		<td><a href="noticeModifyForm.do?num=${notice.num}&pageNum=${pageNum}">수정</a>
			<input type="hidden" name="pageNum" value="${pageNum}">
		</td>
		
		<td>
			<c:if test="${authUser.manager_flag == 1 }">
			<a href="noticeDelete.do?num=${notice.num}&pageNum=${currentPage}">삭제</a>
			</c:if>
	...
	<tr>
		<td><a href="noticeList.do?pageNum=${pageNum }">목록으로</a></td>
	</tr>
</table>
		</div>
	</div>
